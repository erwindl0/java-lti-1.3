...
public class ToolLineItemServiceClient {
	...
	public ToolLineItemServiceClient(final URI lineItemsUri, final String resourceLinkId, final boolean canRead, final boolean canManage, final LineItemServiceClient lineItemServiceClient) {
		this.lineItemsUri = lineItemsUri;

...
public class Tool {
	...
	public AccessTokenResponse getAccessToken() throws IOException, BadToolProviderConfigurationException {
		...
		if (accessTokenResponse == null) {
			AccessTokenRequestHandler accessTokenRequestHandler = new AccessTokenRequestHandler(kid, registration, toolBuilders.getClientCredentialsTokenBuilder(), toolBuilders.getAccessTokenRequestBuilder());
	...
	public DeepLinkingClient getDeepLinkingClient() {
		...
		return new DeepLinkingClient(toolBuilders.getDeepLinkingTokenBuilder(), getIssuer(), registration.getClientId(), kid, this.claimAccessor.getAzp(), getDeploymentId(), this.claimAccessor.get(ClaimsEnum.NONCE), getDeepLinkingSettings());
	}
	...
	public Tool(final Registration registration, final ClaimAccessor claimAccessor, final OIDCLaunchSession oidcLaunchSession, final ToolBuilders toolBuilders, final String kid) {
